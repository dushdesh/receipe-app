package com.dushdesh.receipeapp.bootstrap;

import com.dushdesh.receipeapp.models.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacNotes.setText("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\n" +
        ...
        tacoNotes.setText("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
